...
{
    if (doubleShoot)
        SDL_RenderCopy(renderer, doubleShootTexture, NULL, &doubleShootRect);
    if (increaseDamage)
        SDL_RenderCopy(renderer, increaseDamageTexture, NULL, &increaseDamageRect);
    if (heal)
        SDL_RenderCopy(renderer, healTexture, NULL, &healRect);
}