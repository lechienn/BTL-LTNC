...
void Menu::handleEvent()
{
    ...
    case SDL_MOUSEMOTION:
        ...
        if (x >= destRect1.x && x <= (destRect1.x + destRect1.w) && y >= destRect1.y && y <= (destRect1.y + destRect1.h))
            inside1 = 1;
        else
            inside1 = 0;
        if (x >= destRect2.x && x <= (destRect2.x + destRect2.w) && y >= destRect2.y && y <= (destRect2.y + destRect2.h))
            inside2 = 1;
        else
            inside2 = 0;
        break;
